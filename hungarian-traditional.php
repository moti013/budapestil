...
<head>
<meta charset="UTF-8" /><link rel="canonical" href="https://budapestil.co.il/hungarian-traditional" />
...
<title>מסעדות הונגריות מסורתיות בבודפשט - בודפשט איי אל</title>
<meta name="keywords" content="בודפשט, budapestil, budapest,  בודפשט מסעדות הונגריות, אוכל הונגרי בבודפשט, מסעדות הונגריות בבודפשט,">
<meta name="description" content="מסעדות הונגריות מסורתיות בבודפשט, גולש, לנגוש, קורטוש, ראקוט קרומפלי ועוד מאכלים הונגריים שורשיים שתוכלו לאכול רק בבודפשט">
...
<div class="main">
<div class="article">
<h1>מסעדות הונגריות מסורתיות בבודפשט</h1><div class="fastnav"><span class="bfastnav">ניווט מהיר בדף</span><br/>
<a href="#מסעדת פלודה ודלודה" onclick="scrollTo(this)">מסעדת פלודה ודלודה</a>
<a href="#גטו גולש" onclick="scrollTo(this)">גטו גולש</a>
<a href="#פריצי פאפא" onclick="scrollTo(this)">פריצי פאפא</a>
<a href="#מסעדת הוסאר" onclick="scrollTo(this)">מסעדת הוסאר</a>
</div>
<?php $url="https://budapestil.co.il/hungarian-traditional"; $tarrel="rel='noopener noreferrer nofollow' target='_blank'"; ?><div class="sharebar"><a class="face" <?php echo $tarrel; ?> href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url; ?>"><i class="fa fa-facebook"></i></a><a class="mail" <?php echo $tarrel; ?> href="mailto:?subject=שיתוף&body=<?php echo $url; ?>"><i class="fa fa-envelope"></i></a><a class="whatsapp" <?php echo $tarrel; ?> href="whatsapp://send?text=<?php echo $url; ?>"><i class="fa fa-whatsapp"></i></a><a class="twitter" <?php echo $tarrel; ?> href="http://www.twitter.com/share?url=<?php echo $url; ?>"><i class="fa fa-twitter"></i></a></div><hr/>

אין טעם להכביר במילים על האוכל ההונגרי, הוא פשוט, כבד, מנחם וטעים.

בודפשט של היום לעומת זאת, כמו כל עיר מערבית מתוירת, מלאה במסעדות המגישות מאכלים מכל העולם, קשה יותר ויותר למצוא את המטבח ההונגרי המקורי מלא הטעמים.
למרות זאת נותרו עדיין כמה פינות חמד עם מפות משובצות על השולחנות שאני נוהג לפקוד, במיוחד בימי חורף קרים.

אני שמח לשתף אתכם בכמה מפינות החמד הללו ברחבי בודפשט, ברובן מי שיגיש לכם את האוכל יהיה גם הבעלים והטבח כבר עשרות שנים, לא יהיו לו כוכבי מישלן או המלצות באתרים גדולים, אבל יהיה לו אוכל טעים מאוד להציע לכם. את המסעדות האלו ואת האוכל הזה אתם תזכרו לאורך זמן, מבטיח.

תהנו ואל תשכחו לשתף.

</div>

<div class="article" id="מסעדת פלודה ודלודה">
<h2>פלודה ודלודה - Faloda & Daloda</h2>
<div class="gallery"><img src="images/korhaly1.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/korhaly2.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/korhaly3.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/korhaly4.jpg" alt="מסעדה מקומית בודפשט" /></div>

מתוך המלצה של שרית שפיר ב<a href="">קבוצת הפייסבוק בודפשט איי אל</a>
"<i>פתחנו את החופשה שלנו בארוחת ערב טעימה במיוחד! מחיר סביר, שירות מצוין, אווירה נעימה - בהחלט מסעדה מומלצת!</i>".


<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="https://goo.gl/maps/tfNYqJzAPpR2"><div class="navigateto"><span style="color:yellowgreen">לחצו <i class="fa fa-address"></i> לניווט</span><br />Liszt Ferenc tér 7, Budapest 1061</div></a>
<a rel="noopener noreferrer nofollow" target="_blank" href="tel:+36-1-321-0280"><div class="navigateto" dir="ltr"><i class="fa fa-phone"></i><br />+36-1-321-0280</div></a>
</div>
<div class="col2for">
<div class="navigateto"><i class="fa fa-clock"></i><br />כל יום: 11:30-24:00</div>
<div class="navigateto" dir="ltr"><i class="fa fa-money"></i><br/><i class="fa fa-euro"></i></div>
</div>
<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="http://www.korhelyfaloda.hu/"><div class="navigateto"><i class="fa fa-website"></i><br />עברו לאתר האינטרנט</div></a>
<div class="navigateto"><i class="fa fa-metro"></i><br />קו מטרו M1<br />תחנת Oktogon</div>
</div>
<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:kapcsolat@huszar-etterem.hu"><div class="navigateto" dir="ltr"><i class="fa fa-envelope"></i><br />שלחו מייל למסעדה</div></a>
<div class="accordion"><?php $tablename="comments_korhaly"; $counter = 0; $result = mysqli_query($con,"SELECT * FROM $tablename");while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {if ($row['name']=='') continue; $counter++;} print "<div class='counter'>$counter תגובות התפרסמו | יש לכם מה להוסיף?</div>";?></div><div class="panel">
...
<div class="article" id="גטו גולש">
<h2>גטו גולש - Gettó Gulyás</h2>
<div class="gallery"><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/getogulas1.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/getogulas2.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/getogulas3.jpg" alt="מסעדה מקומית בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/getogulas4.jpg" alt="מסעדה מקומית בודפשט" /></div>

מסעדה הונגרית אותנטית שמעבר לגולש המפורסם המוגש בה תוכלו למצוא גם טורוש גומבוץ.


<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="https://goo.gl/maps/D2fjbWKYRNU2"><div class="navigateto"><span style="color:yellowgreen">לחצו <i class="fa fa-address"></i> לניווט</span><br />Wesselényi u. 18, Budapest 1077</div></a>
<a rel="noopener noreferrer nofollow" target="_blank" href="tel:+36-20-376-4480"><div class="navigateto" dir="ltr"><i class="fa fa-phone"></i><br />+36-20-376-4480</div></a>
</div>
<div class="col2for">
<div class="navigatetolong"><i class="fa fa-clock"></i><br />ראשון-חמישי: 12:00-23:00
שישי: 12:00-00:00
שבת: 12:00-23:00</div>
...
<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="https://www.facebook.com/gettogulyas/"><div class="navigateto"><i class="fa fa-facebook"></i><br />עברו לדף הפייסבוק</div></a>
<div class="navigateto"><i class="fa fa-metro"></i><br />קו מטרו M2<br />תחנת Astoria</div>
</div>
<div class="accordion"><?php $tablename="comments_getogulas"; $counter = 0; $result = mysqli_query($con,"SELECT * FROM $tablename");while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {if ($row['name']=='') continue; $counter++;} print "<div class='counter'>$counter תגובות התפרסמו | יש לכם מה להוסיף?</div>";?></div><div class="panel">
<?php $result = mysqli_query($con,"SELECT * FROM $tablename"); $first_row = false; $i=0; $x="&nbsp;"; while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {$i++; if ($row['name']=='') continue; print "<div class='title'>$i.$x$row[title]</div>"; print "<div class='dateandname'>$row[name] || $row[datetime]</div>"; print "<div class='comments'>$row[comment]</div>"; echo '<br>';} ?><hr/><div class="align-c"><b>הוסיפו תגובה לכתבה</b></div><br/><form action="/assets/comments/comments" method="post"><input type="hidden" name="verible" value="<?php echo $tablename; ?>"><div class="col2"><input type="text" name="name" placeholder="שם מלא" required><input type="text" name="title" placeholder="כותרת" required></div>
<textarea type="text" name="comment" placeholder="תגובה" required></textarea><br />
<input type="submit" value="שלח" class="align-l">
</form></div>
...
<div class="article" id="פריצי פאפא">
<h2>פריצי פאפא - Frici Papa</h2><span class="image fit"><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/fricipapa.jpeg" alt="מסעדה אותנטית בודפשט" />מסעדת פריצי פאפא</span> 

מתוך המלצה של רחל מנדלוביץ' ב<a href="">קבוצת הפייסבוק בודפשט איי אל</a>
"<i>פריצי פאפא ברחוב קיראלי 53. עממית, טעימה וחביבה יוצאים בטעם של מתי נתראה שוב</i>".


<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="https://goo.gl/maps/xXV3xdjZSTs"><div class="navigateto"><span style="color:yellowgreen">לחצו <i class="fa fa-address"></i> לניווט</span><br />Király u. 55, Budapest 1077</div></a>
<a rel="noopener noreferrer nofollow" target="_blank" href="tel:+36-1-351-0197"><div class="navigateto" dir="ltr"><i class="fa fa-phone"></i><br />+36-1-351-0197</div></a>
</div>
<div class="col2for">
<div class="navigateto"><i class="fa fa-clock"></i><br />ראשון: סגור
שני-שבת: 11:00-23:00</div>
<div class="navigateto" dir="ltr"><i class="fa fa-money"></i><br/><i class="fa fa-euro"></i></div>
</div>
<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="http://fricipapa.hu/eng/index.php"><div class="navigateto"><i class="fa fa-facebook"></i><br />עברו לאתר האינטרנט</div></a>
<div class="navigateto"><i class="fa fa-metro"></i><br />קו מטרו M1<br />תחנת Oktogon</div>
</div>
<div class="accordion"><?php $tablename="comments_frici"; $counter = 0; $result = mysqli_query($con,"SELECT * FROM $tablename");while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {if ($row['name']=='') continue; $counter++;} print "<div class='counter'>$counter תגובות התפרסמו | יש לכם מה להוסיף?</div>";?></div><div class="panel">
<?php $result = mysqli_query($con,"SELECT * FROM $tablename"); $first_row = false; $i=0; $x="&nbsp;"; while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {$i++; if ($row['name']=='') continue; print "<div class='title'>$i.$x$row[title]</div>"; print "<div class='dateandname'>$row[name] || $row[datetime]</div>"; print "<div class='comments'>$row[comment]</div>"; echo '<br>';} ?><hr/><div class="align-c"><b>הוסיפו תגובה לכתבה</b></div><br/><form action="/assets/comments/comments" method="post"><input type="hidden" name="verible" value="<?php echo $tablename; ?>"><div class="col2"><input type="text" name="name" placeholder="שם מלא" required><input type="text" name="title" placeholder="כותרת" required></div>
<textarea type="text" name="comment" placeholder="תגובה" required></textarea><br />
<input type="submit" value="שלח" class="align-l">
</form></div>
...
<div class="article" id="מסעדת הוסאר">
<h2>הוסאר - Huszár Étterem</h2><div class="gallery"><img src="images/huszar1.jpg" alt="מסעדת הוסאר אוכל הונגרי אותנטי  בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/huszar2.jpg" alt="מסעדת הוסאר אוכל הונגרי אותנטי  בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/huszar3.jpg" alt="מסעדת הוסאר אוכל הונגרי אותנטי  בודפשט" /><img class="lazy" src="preimg.png" data-src="preimg.png" data-srcset="images/huszar5.jpg" alt="מסעדת הוסאר אוכל הונגרי אותנטי  בודפשט" /></div>

מתוך המלצה של אביגיל יהודאי ב<a href="">קבוצת הפייסבוק בודפשט איי אל</a>
"<i>הלכנו למסעדת "הוסאר" - אוכל הונגרי אותנטי ומעולה, אוירה נעימה במסעדה ומחירים פשוט מגוחכים. ממליצה לנסות את מרק הגולש שלהם</i>".


<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="https://goo.gl/maps/UdbF4SXSZH82"><div class="navigateto"><span style="color:yellowgreen">לחצו <i class="fa fa-address"></i> לניווט</span><br />János Pál pápa tér 22, Budapest 1081</div></a>
<a rel="noopener noreferrer nofollow" target="_blank" href="tel:+36-1-303-9940"><div class="navigateto" dir="ltr"><i class="fa fa-phone"></i><br />+36-1-303-9940</div></a>
</div>
<div class="col2for">
<div class="navigateto"><i class="fa fa-clock"></i><br/>כל יום: 12:00-22:00</div>
<div class="navigateto" dir="ltr"><i class="fa fa-money"></i><br/><i class="fa fa-euro"></i></div>
</div>
<div class="col2for">
<a rel="noopener noreferrer nofollow" target="_blank" href="http://huszar-etterem.hu/"><div class="navigateto"><i class="fa fa-website"></i><br />עברו לאתר האינטרנט</div></a>
<div class="navigateto"><i class="fa fa-metro"></i><br />קו מטרו M2<br />תחנת Keleti Pályaudvar</div>
</div>
<a rel="noopener noreferrer nofollow" target="_blank" href="mailto:kapcsolat@huszar-etterem.hu"><div class="navigateto" dir="ltr"><i class="fa fa-envelope"></i><br />שלחו מייל למסעדה</div></a>
<div class="accordion"><?php $tablename="comments_husar"; $counter = 0; $result = mysqli_query($con,"SELECT * FROM $tablename");while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {if ($row['name']=='') continue; $counter++;} print "<div class='counter'>$counter תגובות התפרסמו | יש לכם מה להוסיף?</div>";?></div><div class="panel">
<?php $result = mysqli_query($con,"SELECT * FROM $tablename"); $first_row = false; $i=0; $x="&nbsp;"; while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {$i++; if ($row['name']=='') continue; print "<div class='title'>$i.$x$row[title]</div>"; print "<div class='dateandname'>$row[name] || $row[datetime]</div>"; print "<div class='comments'>$row[comment]</div>"; echo '<br>';} ?><hr/><div class="align-c"><b>הוסיפו תגובה לכתבה</b></div><br/><form action="/assets/comments/comments" method="post"><input type="hidden" name="verible" value="<?php echo $tablename; ?>"><div class="col2"><input type="text" name="name" placeholder="שם מלא" required><input type="text" name="title" placeholder="כותרת" required></div>
<textarea type="text" name="comment" placeholder="תגובה" required></textarea><br />
<input type="submit" value="שלח" class="align-l">
</form></div>
